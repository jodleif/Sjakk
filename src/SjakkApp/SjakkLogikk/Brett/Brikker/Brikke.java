...
public abstract class Brikke
{
	...
	/**
	 * Forsøkte å implementere sjekking for sjakk,
	 * Men fikk det ikke til å fungere sammen med AIen - skikkelig
	 *
	 * @return false. (DUMMY METODE)
	 */
	...
	private boolean sjekkForKollisjoner(int sjakkPos)
	{
		...
		return tmp != null && (tmp.getFarge() == getFarge());
	}
