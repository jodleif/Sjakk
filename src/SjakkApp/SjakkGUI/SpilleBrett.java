...
import SjakkApp.SjakkLogikk.Brett.Brikker.Brikke;
 ...
 * <p>
 * Spillebrettets representasjon i SjakkApp
 */
public class SpilleBrett
{
	...
	private Rute[][] ruter; // Her lagres SjakkApp representasjonen av spillruter.
	...
	/**
	 * Oppretter et nytt SjakkApp-brett
	 *
	...
	/**
	 * Hent ut rute (SjakkApp element) fra ruter tabellen
	 *
